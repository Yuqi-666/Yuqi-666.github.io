...
![头图](https://segmentfault.com/img/bVcXp1a?spec=cover)
...
![](https://segmentfault.com/img/remote/1460000041291745)
...
![](https://segmentfault.com/img/remote/1460000041291759)
...
![](https://segmentfault.com/img/remote/1460000041291746)

2. 打开Scriptable，点击右上角➕，粘贴从小物件屋小程序里复制的安装小组件代码

![](https://segmentfault.com/img/remote/1460000041291696)

3. 点击右下角▶️运行按钮进行下载安装组件代码，若需要配置小物件(如: 设置背景图片等)，会弹出弹窗，根据提示下一步操作即可，若无任何反应则表示无需配置，接下去点击左上角的Done按钮即可

![](https://segmentfault.com/img/remote/1460000041291697)

4. 回到iPhone桌面，长按，添加组件，选择Scriptable应用，勾选刚刚添加的小组件代码，完成显示效果😃
    
    ![](https://segmentfault.com/img/remote/1460000041291747)
